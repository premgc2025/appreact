...
function Treking() {
    ...
    let products = [
        ...
        { name: "Manaslu", image: "./image/manaslu.jpeg", Duration: "15-Days", Price: "$1300", Description: "(September to November) (March to April)" },
        { name: "Mountain Nepal", image: "./image/Lukla.JPG", Duration: "10-Days", Price: "$1000", Description: "(September to November) (March to April)" },
        { name: "Everest Base Camp", image: "./image/EBC.jpeg", Duration: "15-Days", Price: "$1500", Description: "(September to November) (March to April)" },
        { name: "Macchapuchhre", image: "./image/Macchapuchhre.jpeg", Duration: "15-Days", Price: "$500", Description: "(September to November) (March to April)" },
        { name: "Manaslu", image: "./image/manaslu.jpeg", Duration: "15-Days", Price: "$1300", Description: "(September to November) (March to April)" },
        { name: "Mountain Nepal", image: "./image/Lukla.JPG", Duration: "10-Days", Price: "$1000", Description: "(September to November) (March to April)" },
